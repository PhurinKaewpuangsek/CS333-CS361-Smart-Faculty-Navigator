...
- AWS credentials for CI/CD are stored as GitHub Secrets (`AWS_OIDC_ROLE_ARN`, `AWS_REGION`). The IAM identity must use a least-privilege policy, not AdministratorAccess.
